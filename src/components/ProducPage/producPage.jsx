     ...
     <>
       {
         singleProduct.map((item)=>{
              return <div>
                     <div key={item.id} className=' inline-block ml-5 h-[650px] w-[80%] m-auto my-7   border-2 border-gray-800 dark:bg-gray-300 text-black  sm:flex  sm:h-[350px] sm:w-[55%] sm:m-auto sm:my-7 lg:my-7  ' >
